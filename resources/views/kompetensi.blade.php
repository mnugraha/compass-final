...
@section('konten-tanpa-frame')
                        ...
                        <tbody>
                            @foreach ($kompetensiA as $x)
                                <tr>
                                    ...
                                    <td>{{ $x->definisi }}</td>
                                    <td><a href="{{ $x->id_kompetensi }}" class="btn btn-default"> Detail</a></td>
                                </tr>
                            @endforeach
    ...
    <a href="/#skema" class="btn btn-default btn-icon-fixed" style="box-shadow: -1px 2px 3px #888888"><span
