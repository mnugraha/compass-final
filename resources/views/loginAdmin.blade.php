...
<body>
    ...
    <div class="app app-fh">
        ...
        <div class="app-container" style="background: url(/) center center no-repeat fixed;">
            <div class="app-login-box" style="background-color:cadetblue ">
                <div class="">
                    <center><img src="/login-admin.png" height="150px" style="margin-top: 20px"></center>
                </div>
                ...
                <div class="app-login-box-container">
                    <form action="/login_prosesAdmin" method="post">
                        @csrf
                        @if ($errors->any())
                ...
                <div class="app-login-box-footer" style="background-color: dimgray;color: aliceblue">
