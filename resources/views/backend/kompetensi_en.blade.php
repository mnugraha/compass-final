...
@section('sub-judul')
    Manage Data Competencies
@endsection

@section('konten')
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title"><span class="fa fa-bar-chart-o"></span> Insert Data Competencies</h3>
        </div>
        <div class="panel-body">
            <form class="form-horizontal" method="POST" action="/kompetensiSimpan_en">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <label class="col-md-1 control-label">Definition</label>
                        <div class="col-md-11">
        ...
        <table class="table table-striped table-bordered datatable-extended">
            <thead>
                <tr>
                    ...
                    <th class="text-center" style="font-size: 14px">Competecies</th>
                    <th class="text-center" style="font-size: 14px">Value</th>
                    <th class="text-center" style="font-size: 14px">Definition</th>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="myModalLabel">Edit Data Competencies </h5>

                        </div>
                        <div class="modal-body">
                            <form class="row gx-3 gy-2 align-items-center" method="POST"
                                action="/kompetensiUpdate_en/{{ $x->id_kompetensi }}">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <div class="col-md-12">
            ...
            <div id="hapus{{ $x->id_kompetensi }}" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <form class="row gx-3 gy-2 align-items-center" method="POST"
                                action="/kompetensiDelete_en/{{ $x->id_kompetensi }}">
                                {{ csrf_field() }}
                                <br>
